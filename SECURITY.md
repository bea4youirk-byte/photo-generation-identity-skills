...
- Never commit passwords, access tokens, API keys, cookies, or credentials.
- Never commit private reference photographs unless the repository is private and the owner explicitly approves the exact files.
